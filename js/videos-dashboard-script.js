...
function renderVideo(id, src, title) {
    ...
    let card = `<div class="card">
                    ...
                    <div class="btn-group thumb-btn" role="group" aria-label="...">
                        <button type="button" class="btn btn-default" onclick="redirection()">View</button>
...
//function when click on "view" button will link to display-video page
function redirection(){
    window.location="display-video.html"
}